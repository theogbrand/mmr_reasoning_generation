...
class RAVENRunner:
    ...
    def __init__(
        ...
        self.datasets = {
            'train': load_dataset("HuggingFaceM4/RAVEN", "in_distribute_four_out_center_single", split="train"),
            'validation': load_dataset("HuggingFaceM4/RAVEN", "in_distribute_four_out_center_single", split="validation"),
            'test': load_dataset("HuggingFaceM4/RAVEN", "in_distribute_four_out_center_single", split="test")
        }
